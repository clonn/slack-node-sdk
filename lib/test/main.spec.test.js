...
describe('slack new Webhook class test', function() {
  var webhook;
  this.timeout(50000);
  ...
  it('should create a webhook object', function(done) {
    webhook.should.be.an.Object;
    return done();
  });
  it('should send a correct response', function(done) {
    return webhook.respond("This is posted to #general and comes from a bot named webhookbot.", function(err, response) {
      if (err) {
        return done(err);
      }
      response.should.be.ok.and.an.Object;
